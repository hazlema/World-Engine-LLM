...
All settings live in `.env` for now.
...
## You don't have to touch these; they are for development purposes.
...
## If you don't have or can't run LM Studio, you can enable
## these and do everything with Gemini.
## Not free; requires an API key.
